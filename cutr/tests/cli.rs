...
// --------------------------------------------------
fn dies(args: &[&str], expected: &str) -> MyResult<()> {
    Command::cargo_bin(PRG)?
        .args(args)
        .assert()
        .failure()
...
// --------------------------------------------------
#[test]
fn dies_not_enough_args() -> MyResult<()> {
    dies(
        &[CSV],
...
// --------------------------------------------------
#[test]
fn dies_bad_digit_field() -> MyResult<()> {
...
// --------------------------------------------------
#[test]
fn dies_bad_digit_bytes() -> MyResult<()> {
    let bad = random_string();
    dies(
        &[CSV, "-b", &bad],
        &format!(r#"illegal list value: "{}""#, &bad),
...
// --------------------------------------------------
#[test]
fn dies_bad_digit_chars() -> MyResult<()> {
    let bad = random_string();
    dies(
        &[CSV, "-c", &bad],
        &format!(r#"illegal list value: "{}""#, &bad),
...
// --------------------------------------------------
#[test]
fn dies_empty_delimiter() -> MyResult<()> {
    dies(
        &[CSV, "-f", "1", "-d", ""],
...
// --------------------------------------------------
#[test]
fn dies_bad_delimiter() -> MyResult<()> {
    dies(
        &[CSV, "-f", "1", "-d", ",,"],
        r#"--delim ",," must be a single byte"#,
    )
...
// --------------------------------------------------
#[test]
fn dies_chars_bytes_fields() -> MyResult<()> {
    Command::cargo_bin(PRG)?
...
// --------------------------------------------------
fn run_lossy(args: &[&str], expected_file: &str) -> MyResult<()> {
