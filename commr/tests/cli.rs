...
// --------------------------------------------------
#[test]
fn file1_file2_1_delim() -> MyResult<()> {
    run(
        &[FILE1, FILE2, "-1", "-d", ":"],
...
// --------------------------------------------------
#[test]
fn file1_file2_2_delim() -> MyResult<()> {
    run(
        &[FILE1, FILE2, "-2", "-d", ":"],
...
// --------------------------------------------------
#[test]
fn file1_file2_3_delim() -> MyResult<()> {
    run(
        &[FILE1, FILE2, "-3", "-d", ":"],
...
// --------------------------------------------------
#[test]
fn file1_file2_12_delim() -> MyResult<()> {
    run(
        &[FILE1, FILE2, "-12", "-d", ":"],
...
// --------------------------------------------------
#[test]
fn file1_file2_23_delim() -> MyResult<()> {
    run(
        &[FILE1, FILE2, "-23", "-d", ":"],
...
// --------------------------------------------------
#[test]
fn file1_file2_13_delim() -> MyResult<()> {
    run(
        &[FILE1, FILE2, "-13", "-d", ":"],
...
// --------------------------------------------------
#[test]
fn file1_file2_123_delim() -> MyResult<()> {
    run(
        &[FILE1, FILE2, "-123", "-d", ":"],
